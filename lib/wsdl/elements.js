...
var MessageElement = /** @class */ (function (_super) {
    ...
    MessageElement.prototype.postProcess = function (definitions) {
        ...
        for (var i = 0; part = this.children[i]; i++) {
            ...
            if (part.$type) {
                ...
                this.parts[part.$name] = this._qualifyElementPart(definitions, part)[0];
            }
    ...
    MessageElement.prototype._qualifyElementPart = function (definitions, part) {
        var lookupTypes = [];
        ...
        if (elementChildren.length > 0) {
            for (var _i = 0, elementChildren_1 = elementChildren; _i < elementChildren_1.length; _i++) {
                var child = elementChildren_1[_i];
        ...
        if (element.$type) {
            var type = utils_1.splitQName(element.$type);
...
var SchemaElement = /** @class */ (function (_super) {
    ...
    SchemaElement.prototype.merge = function (source) {
        ...
        _.merge(this, _.pickBy(source, function (value, key) {
            return key.indexOf('$') === 0 && !_this.hasOwnProperty(key);
        }));
        return this;
    };
