...
var httpntlm_1 = __importDefault(require("httpntlm"));
...
var HttpClient = /** @class */ (function () {
    function HttpClient(options) {
        options = options || {};
        this._request = options.request || request_1["default"];
    }
    /**
    ...
    HttpClient.prototype.request = function (rurl, data, callback, exheaders, exoptions, caller) {
        ...
        if (exoptions !== undefined && exoptions.hasOwnProperty('ntlm')) {
            ...
            options.url = rurl;
            httpntlm_1["default"][options.method.toLowerCase()](options, function (err, res) {
                if (err) {
                    return callback(err);
                }
                // if result is stream
